  ...
  const handleCreateAdmin = async () => {
    ...
    try {
      ...
      const result = await createAdmin({
        ...
        role: "MSWD-CSWDO-PDAO", // FIXED: Added required role field
      });
      if (result?.success) {
      ...
      <Dialog open={isViewModalOpen} onOpenChange={setIsViewModalOpen}>
        <DialogContent className="max-w-3xl">
          ...
          <DialogFooter className="gap-2">
            ...
            {userRole === "admin" && selectedUser?.status !== "Active" && (
              <Button
                variant="default"
      ...
      >
        <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-6">
              <div className="flex items-start justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="font-mono text-sm">{selectedAdmin.admin_id}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{selectedAdmin.phone_number}</p>
                  </div>
                </div>
              </div>
          ...
          <DialogFooter className="gap-2">
            ...
            <Link href={`/dashboard/admins/${selectedAdmin?.admin_id}/edit`}>
              <Button variant="outline">
                <Edit className="h-4 w-4 mr-2" />
                edit
              </Button>
      ...
      <Dialog open={isNewAdminModalOpen} onOpenChange={setIsNewAdminModalOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6 py-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setAdminForm((f) => ({ ...f, address: e.target.value }))
                    }
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                admin id will be auto-generated (e.g. ADMN-1234). role is fixed
                to <strong>MSWD-CSWDO-PDAO</strong>.
              </p>
            </div>
          </div>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleCreateAdmin} disabled={isAdminSubmitting}>
              {isAdminSubmitting ? (
                <RefreshCw className="h-4 w-4 animate-spin mr-2" />
              ) : (
                <Plus className="h-4 w-4 mr-2" />
